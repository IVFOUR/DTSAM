...
class MaskDecoderDT(nn.Module):
    def __init__(
        ...
        *,
        ...
        # DT-SAM parameters
        self.dt_token = nn.Embedding(1, transformer_dim) # HQ-Ouptput-Token
        self.dt_mlp = MLP(transformer_dim, transformer_dim, transformer_dim // 8, 3) # corresponding new MLP layer for HQ-Ouptput-Token
    ...
    def forward(
        ...
        if multimask_output:
            ...
            mask_slice = slice(1,self.num_mask_tokens-3)
