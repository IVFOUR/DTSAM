...
from segment_anything_DT import sam_model_registry
from segment_anything_DT.modeling import TwoWayTransformer, MaskDecoder
...
class MaskDecoderDT(MaskDecoder):
    def __init__(self, model_type):
        ...
        print("DT Decoder init from SAM MaskDecoder")
        ...
        self.selayer = nn.Sequential(
            nn.Conv2d(transformer_dim // 2, transformer_dim // 4, 3, 1, 1),
    ...
    def predict_masks(
        ...
        upscaled_embedding_ours = self.embedding_maskfeature(upscaled_embedding_sam) + dt_feature
...
def get_args_parser():
    ...
    parser = argparse.ArgumentParser('DT-SAM', add_help=False)
...
def main(net, train_datasets, valid_datasets, args):
    ...
    if not args.eval:
        ...
        optimizer = optim.Adam(net.parameters(), lr=args.learning_rate, betas=(0.9, 0.999), eps=1e-08,
                               weight_decay=0)
...
def train(args, net, optimizer, train_dataloaders, valid_dataloaders, lr_scheduler):
    ...
    for epoch in range(epoch_start, epoch_num):
        ...
        for data in metric_logger.log_every(train_dataloaders, 1000):
            ...
            loss_mask, loss_dice = loss_masks(masks_dt, labels / 255.0, len(masks_dt))
...
if __name__ == "__main__":
    ...
    dataset_mvtec = {"name": "MvTecAD",
                     "im_dir": "./data/mvtec_unified/train/images",
                     "gt_dir": "./data/mvtec_unified/train/labels",
                     "im_ext": ".png",
                     "gt_ext": ".png"}

    dataset_visa = {"name": "VisA",
                     "im_dir": "./data/VisA_unified/train/images",
                     "gt_dir": "./data/VisA_unified/train/labels",
                     "im_ext": ".JPG",
                     "gt_ext": ".png"}
    ...
    dataset_mvtec_val = {"name": "MvTecAD-VD",
                         "im_dir": "./data/mvtec_unified/test/images",
                         "gt_dir": "./data/mvtec_unified/test/labels",
                         "im_ext": ".png",
                         "gt_ext": ".png"}

    dataset_visa_val = {"name": "VisA-VD",
                         "im_dir": "./data/VisA_unified/test/images",
