...
from projects.instance_segment_anything.models.segment_anything_DT import sam_model_registry, SamPredictor
from .focalnet_dino.focalnet_dino_wrapper import FocalNetDINOWrapper
from .hdetr.hdetr_wrapper import HDetrWrapper


@DETECTORS.register_module()
class DetWrapperInstanceDTSAM(BaseDetector):
    ...
    def __init__(self,
                 ...
                 train_cfg=None,
                 test_cfg=None):
        super(DetWrapperInstanceDTSAM, self).__init__(init_cfg)
